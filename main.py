...
# you need this library to read the passwords /// don`t need it when running docker, comment out # line 12,13
...
# creating an invoice_month variable with the name of the month
print("Extracting and transforming data from the warehouse")
online_trans_w_description_task1 = extract_transactional_data_month(dbname, host, port, user, password)

# creating an invoice_dow variable that gives you the number of the day of the week
print("Extracting and transforming data from the warehouse")
online_trans_w_description_task2 = extract_transactional_data_dow(dbname, host, port, user, password)

# creating an invoice_dow_name variable that gives you the name of the week? Monday is 0, tuesday is 1…
print("Extracting and transforming data from the warehouse")
